  ...
  const upcomingEvents = [
    {
      ...
      date: "Programação contínua",
      time: "Confira os horários",
      location: "Cinemark Metrópole",
      description: "Os maiores lançamentos do cinema em salas modernas com tecnologia de ponta e conforto premium.",
      image: "🎬",
      highlight: "Em cartaz"
    },
    {
      ...
      category: "Compras",
      date: "Novembro 2025",
      time: "Durante todo o mês",
      location: "Todas as lojas",
      description: "As melhores ofertas do ano com descontos incríveis em todas as categorias e lojas participantes.",
      image: "🛍️",
      highlight: "Promoções especiais"
    },
    {
      id: 3,
      ...
      category: "Natalino",
      date: "Dezembro 2025",
      time: "Programação especial",
      location: "Todo o shopping",
      description: "Decoração natalina completa com apresentações, Papai Noel, coral e atividades temáticas para toda família.",
      image: "🎄",
      highlight: "Magia natalina"
    }
  ];
  ...
  return (
    <section id="eventos" className="py-12 sm:py-16 lg:py-20 bg-gradient-to-br from-primary-subtle via-background to-accent/30">
      <div className="container-modern section-padding">
        ...
        {/* 1. BANNER PRINCIPAL - Próximo Evento */}
        <div className="mb-16 sm:mb-20">
          <Card className="premium-card border-0 overflow-hidden max-w-7xl mx-auto shadow-2xl bg-gradient-to-br from-primary-subtle via-accent to-luxury-subtle relative animate-scale-in">
            ...
            <div className="absolute inset-0 bg-gradient-to-r from-primary-dark via-primary to-luxury p-[2px] rounded-2xl sm:rounded-3xl">
        ...
        {/* 2. PRÓXIMOS EVENTOS - Cards */}
        <div className="mb-16 sm:mb-20">
          <div className="text-center mb-8 sm:mb-12">
            <h3 className="text-2xl sm:text-3xl font-bold mb-4 text-primary-dark">Próximos Eventos</h3>
            <p className="text-muted-foreground max-w-2xl mx-auto">
              Outros eventos especiais que estão por vir no Metrópole Shopping
            </p>
          </div>

          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {upcomingEvents.map((event) => (
              <Card key={event.id} className="premium-card border border-primary/10 overflow-hidden hover:scale-105 hover:shadow-2xl transition-all duration-300 bg-white">
                <div className="h-1 bg-gradient-to-r from-primary via-primary-light to-luxury"></div>
                <CardHeader className="pb-4">
                  <div className="flex items-center justify-between mb-2">
                    <Badge variant="secondary" className="text-xs bg-primary-subtle text-primary border-primary/20">
                      {event.category}
                    </Badge>
                    <span className="text-2xl">{event.image}</span>
                  </div>
                  <CardTitle className="text-lg sm:text-xl text-primary-dark">{event.title}</CardTitle>
